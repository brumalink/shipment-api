...
- Any modification, deletion or reordering of past events is detectable.
- Events are append-only; corrections are recorded as new events referencing the corrected one.
- The custody-chain design is GDP-relevant: changes require QA sign-off (see CODEOWNERS).
